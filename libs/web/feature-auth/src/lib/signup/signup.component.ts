    ...
    <div class="min-h-[calc(100vh-200px)] flex items-center justify-center px-4">
      <div class="w-full max-w-sm velo-glass rounded-2xl p-7">
        <div class="flex items-center gap-2 justify-center mb-6">
          <span class="material-symbols-outlined text-velo-lime text-[28px]">person_add</span>
        ...
        <form (ngSubmit)="onSubmit()" class="space-y-4">
          <label class="block">
            <span class="block text-[10px] text-on-surface-variant uppercase tracking-wider mb-1">Name (optional)</span>
            <input
          ...
          <label class="block">
            <span class="block text-[10px] text-on-surface-variant uppercase tracking-wider mb-1">Password (8+ chars)</span>
            <input
        ...
        <p class="mt-5 text-center text-xs text-on-surface-variant">
          ...
          <a routerLink="/login" class="text-velo-lime hover:underline ml-1">Sign in</a>
        </p>
      </div>
    </div>
  `,
