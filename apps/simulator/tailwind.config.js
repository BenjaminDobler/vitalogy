...
/**
 * Mirror of the mobile Tailwind config so libs/mobile/* components in the
 * phone frame render identically here. Light sidebar UI of the simulator
 * uses standard Tailwind defaults.
 */
