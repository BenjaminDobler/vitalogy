...
/**
 * VeloPulse design tokens (from the Stitch mock).
 *  - Deep obsidian surface with electric-lime hero accent
 *  - Sora for metrics, Space Grotesk for tracked labels, Inter for body
 */
  ...
  theme: {
    extend: {
      colors: {
        ...
        // Electric lime — hero accent for active data + primary CTAs.
        'velo-lime': '#c3f400',
      ...
      fontSize: {
        // Metric typography from the mock.
